...
import { createCanvasApp } from "./app";
...
import { warnIfLegacyBrandedEnvKeysPresent } from "./utils/brandedEnv";

async function bootstrap() {
	warnIfLegacyBrandedEnvKeysPresent();
	...
	const honoApp = await createCanvasApp();
