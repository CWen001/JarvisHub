...
export type WebHeroEvidenceContractModule = {
...
export function loadWebHeroEvidenceContractModule(): WebHeroEvidenceContractModule {
	return requireSharedSchemaModule<WebHeroEvidenceContractModule>("webhero-evidence-contract/index.js");
}
