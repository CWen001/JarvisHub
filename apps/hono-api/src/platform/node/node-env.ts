...
export async function createNodeWorkerEnv(): Promise<any> {
	...
	const env: any = {
		...
		APIMART_IMAGE_API_KEY: process.env.APIMART_IMAGE_API_KEY,
		APIMART_API_KEY: process.env.APIMART_API_KEY,
		APIMART_GEMINI_API_KEY: process.env.APIMART_GEMINI_API_KEY,
		APIMART_API_BASE: process.env.APIMART_API_BASE,
		APIMART_IMAGE_MODEL: process.env.APIMART_IMAGE_MODEL,
		JARVISHUB_FIXED_IMAGE_VENDOR: process.env.JARVISHUB_FIXED_IMAGE_VENDOR,
		JARVISHUB_FIXED_IMAGE_MODEL: process.env.JARVISHUB_FIXED_IMAGE_MODEL,
		...
		CANVAS_API_BASE_URL: process.env.CANVAS_API_BASE_URL,
		JARVISHUB_API_BASE_URL: process.env.JARVISHUB_API_BASE_URL,
		JARVISHUB_API_KEY: process.env.JARVISHUB_API_KEY,
		...
		TASK_LOCAL_PROMPT_AGENT_USER_ID: process.env.TASK_LOCAL_PROMPT_AGENT_USER_ID,
			JARVISHUB_DEV_PUBLIC_BYPASS: process.env.JARVISHUB_DEV_PUBLIC_BYPASS,
		JARVISHUB_DEV_PUBLIC_BYPASS_SECRET: process.env.JARVISHUB_DEV_PUBLIC_BYPASS_SECRET,
		JARVISHUB_DEV_PUBLIC_BYPASS_USER_ID: process.env.JARVISHUB_DEV_PUBLIC_BYPASS_USER_ID,
		JARVISHUB_DEV_PUBLIC_BYPASS_ROLE: process.env.JARVISHUB_DEV_PUBLIC_BYPASS_ROLE,
	};
