...
export default function StatsMemoryDebugger({ className }: { className?: string }): JSX.Element {
  ...
  const [query, setQuery] = React.useState('character reference image')
  const [scopeType, setScopeType] = React.useState<MemoryScopeType>('project')
  const [scopeId, setScopeId] = React.useState('')
  const [memoryType, setMemoryType] = React.useState<MemoryEntryType | ''>('artifact_ref')
  const [tagsInput, setTagsInput] = React.useState('character,reference')
