...
import { formatKind, formatVendor, includesSearchText, paginateItems } from './modelCatalog.utils'
...
export function ModelCatalogModelsSection({
  ...
  const [kindFilterInput, setKindFilterInput] = React.useState<ModelCatalogModelKind | 'all'>('all')
  ...
  const [kindFilter, setKindFilter] = React.useState<ModelCatalogModelKind | 'all'>('all')
    ...
    <>
      ...
      <Group className="stats-model-catalog-model-search" gap="sm" wrap="wrap" align="flex-end">
        ...
        <Select
          ...
          onChange={(value) => setKindFilterInput(((value as ModelCatalogModelKind | 'all' | null) || 'all'))}
