...
type StatsSection = 'overview' | 'system' | 'memory' | 'skills' | 'projects'
  ...
  return (
    <svg className="stats-sparkline" width="100%" height={h} viewBox={`0 0 ${w} ${h}`} preserveAspectRatio="none">
      <defs className="stats-sparkline-defs">
        <linearGradient className="stats-sparkline-gradient" id="canvas-stats-spark-fill" x1="0" y1="0" x2="0" y2="1">
      ...
      <polyline className="stats-sparkline-area" points={area} fill="url(#canvas-stats-spark-fill)" stroke="none" />
