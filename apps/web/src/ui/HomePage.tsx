    ...
    <main className="tc-home-page">
      ...
      >
        ...
        >
          ...
          >
            <Text className="tc-home-page__eyebrow">JarvisHub / 创作入口</Text>
          </motion.div>
          ...
          >
            <Text className="tc-home-page__lede">
              用项目隔离上下文，用画布承载 agent 工作流。
            </Text>
            <Text className="tc-home-page__sublede">
              JarvisHub 将文本、图像、视频、素材和运行记录放进同一个多模态 harness，让 agent 能在真实画布上规划、执行和沉淀结果。
            </Text>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          >
            <Text className="tc-home-page__breach-kicker">进入 JarvisHub 创作现场</Text>
          </motion.div>
          ...
          <div className="tc-home-page__breach-core">
              ...
              <div className="tc-home-page__ritual-device-shell">
                ...
                <Anchor className="tc-home-page__ritual-link" href={workspaceUrl}>
                  <span className="tc-home-page__ritual-copy">
                    ...
                    <span className="tc-home-page__ritual-label">进入项目画布工作台</span>
                  </span>
            ...
            >
              <Text className="tc-home-page__statement-main">创建项目，进入默认画布。</Text>
              <Text className="tc-home-page__statement-copy">
                每个项目隔离素材、上下文和 agent 运行记录；每张画布承载一次可继续扩展的多模态工作流。
              </Text>
            </motion.div>
          </div>
        </motion.div>
