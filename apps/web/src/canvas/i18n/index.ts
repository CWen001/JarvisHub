...
export function setLanguage(lang: 'zh' | 'en'): void {
  ...
  // 保存到本地存储
  getBrowserLocalStorage()?.setItem('canvas-language', lang);
}

/**
 * 初始化语言设置
 *
 * NOTE: UI is locked to English. Browser locale and any cached
 * `canvas-language` localStorage value are intentionally ignored.
 */
